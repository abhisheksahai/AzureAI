...
namespace ContentSafetySampleCode
{
	...
	public class Program
	{
		static async Task Main(string[] args)
		{
			...
			string endpoint = "https://content-safety-udemy-course.cognitiveservices.azure.com/";
			string subscriptionKey = "AnJry9ZSUGsytlcSEHJmYXD50Hr9If3TDAF6TzjM3k98JLB3Ne8VJQQJ99BLACYeBjFXJ3w3AAAHACOGURG4";
			...
			Console.WriteLine("Enter text to check the content safety:");
